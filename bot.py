...
# ================= تنظیمات =================
# فقط توکن ربات از متغیر محیطی گرفته می‌شود
...
# سایر تنظیمات مستقیماً در کد (بدون نیاز به secret)
ALLOWED_USER_ID = 1193977634          # فقط این کاربر مجاز است
ADMIN_USERNAME = "@mindscoder"        # ادمین پشتیبانی
BOT_USERNAME = "@pedarattubebot"      # نام کاربری ربات
...
UPLOAD_RETRY_COUNT = 5                # تعداد تلاش‌های مجدد برای آپلود هر قطعه
UPLOAD_RETRY_DELAY = 3                # تأخیر بین تلاش‌ها (ثانیه)
...
def process_download_url(chat_id: int, reply_to: int, url: str):
    ...
    try:
        ...
        if file_size <= MAX_FILE_SIZE:
            ...
            # تقسیم و آپلود قطعات با اطمینان از موفقیت هر قطعه
